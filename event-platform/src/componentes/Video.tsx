                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 mt-6">
                                <img
                                 ...
                                 src="https://github.com/Gabriel-Fernandes1917.png" 
                                 alt="" 
                                 />

                                <div className="leading-relaxed">
                                    <strong className="font-bold text-2xl block">Maycon Loura</strong>
                                    <span className="text-gray-200 text-sm block">CTO @Marivel</span>
                                </div>
                    ...
                    <div className="gap-8 mt-20 grid grid-cols-2">
                        ...
                        <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                            ...
                            <div className="py-6 leading-relaxed">
                                ...
                                <p className="text-sm text-gray-200 mt-2">
                                    baixar papaeis de parede do evento 
                                </p>
                            </div>
                            <div className="h-full p-6 flex items-center">
                                <CaretRight size={24} />
